...
namespace tcc_core.Controllers
{
    public class ProjetoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Coordenador,Natureza,DtInicio,DtFinal")] Projeto projeto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Coordenador,Natureza,DtInicio,DtFinal")] Projeto projeto)
        {
            if (id != projeto.Id)
            {
                return NotFound();
